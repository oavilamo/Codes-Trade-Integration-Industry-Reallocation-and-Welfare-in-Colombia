...
%Imports
IM(1,i) =  (1-omega(1,i,1))*theta_s(1,i)*PI_0(1,i)*P(1,i)^(theta_s(1,i)-1)*D(1,i)*tau(1,i,2)^(-theta_s(1,i))*...
            (xi_1(1,i,2)^(1-theta_s(1,i))*NX_1(1,i)/n_1(1,i)*Psi_1(1,i)+...
             xi_0(1,i,2)^(1-theta_s(1,i))*NX_0(1,i)/n_0(1,i)*Psi_0(1,i)); 
...
mm(1,i) = (1-alpha(1,i)-kappa(1,i))/kappa(1,i)*W(1,1)/P_M(1,i)*Lp(1,i);
...
for i= 1:S
   mu(1,i) = 1/C(1,1)/P_C(1,1)*P_K(1,i);    
end
