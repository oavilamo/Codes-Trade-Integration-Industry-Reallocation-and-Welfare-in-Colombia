function [SS0, P_C, Q, C, W, NT, P, K, P_K, R_K, X_C, I, D_K, X_K, X, D, MC, PI_0, a_p, a_0, a_1, ...
    ...
    GO_EX, GO_NoEX, EX_0, EX_1, P_M, mm, X_M, M, D_M, MC_CD, CD, Lp_T, EX_S] = Steady_State_AsymTau(x)

global beta delta theta eta n sigma omega_c omega_k omega alpha theta_s fe fp f0 f1 xi_0 xi_1 tau S CO L  ...
     kappa sigma_m lambda A TauT0
index = 1;
...
SS0(index) = EX_T(1,1) - IM_T(1,1); index = index+1;

SS0(index) = TauT(1,1)/IM_T(1,1) - TauT0;
